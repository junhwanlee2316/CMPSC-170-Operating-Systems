...
#define START_READ() locks[hash].startRead()
#define END_READ() locks[hash].doneRead()
#define START_WRITE() locks[hash].startWrite()
#define END_WRITE() locks[hash].doneWrite()
#define SYNC_INIT locks = new RWLock[TABLE_SIZE]();
